...
#     temporary variables; users can set them in their environment.
#   * The complexity here is that options containing spaces://must not be
#     temporary, but users can set them in their environment.
